...
function g(d) {
    return `<div class="row mt-2"><a href="/Publication/View/${d.PublicationId}"><img style="width:100%" src='${d.Image}' /></a></div>`
}
$(document).ready(() => {
    var infinity = new InfinityScroll("final_image", "/Account/CreatorImages", g , 20, { "username": document.getElementById("username").value } )
})
////var count = 0;
////var lastView = null
